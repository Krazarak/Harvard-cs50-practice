...
// If no or more than 1 command-line argument is passed in, return error
    if (argc != 2)
    {
        printf("Usage: ./substitution key\n");
        return 1;
    }
// ** If key is invalid (not 26 chars, not alphabetical, & not containing each letter exactly once), return errors
